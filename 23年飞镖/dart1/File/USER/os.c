...
{.Name="Data_Send_Task",   .Func=Data_Send_MainControl2_Task,    .State=OS_READY,    .TimeDelay=1000*1,   .TimeUsedLeast=0xFFFFFFFF},
{.Name="Data_Send_Sensor_Task",   .Func=Data_Send_Sensor_Task,    .State=OS_READY,    .TimeDelay=1000*1,   .TimeUsedLeast=0xFFFFFFFF}
