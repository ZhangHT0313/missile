...
#define USART3_Rx_DMAbuf_LEN  10  //力传感器2
#define USART3_Tx_DMAbuf_LEN  5  //力传感器2

#define USART2_Tx_DMAbuf_LEN  5		//力传感器1
#define USART2_Rx_DMAbuf_LEN  10	//力传感器1

#define UART5_Rx_DMAbuf_LEN  500  //裁判系统
#define UART5_Tx_DMAbuf_LEN  128 //裁判系统

#define UART5_RXMB_LEN             250   //实时功率和热量数据
...
typedef struct
{
	uint16_t data_main2_fps;
	uint16_t data_main2_counter;
	uint16_t data_sensor_fps;
	uint16_t data_sensor_counter;
